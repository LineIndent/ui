# ---------------------------------------------------------------------------
# SHADCN COLOR THEMES
# Sourced from https://ui.shadcn.com/themes
# Two tiers:
#   "base" themes have full light+dark palettes (neutral, stone, zinc, etc.)
#   "color" themes only define primary+charts and inherit from a base theme
#
# To add a new theme: append an entry. The seed engine picks it automatically.
# ---------------------------------------------------------------------------

# Base themes — full light + dark palette
BASE_THEMES = [
    {
        "id": "neutral",
        "label": "Neutral",
