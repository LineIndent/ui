...
--CODE(["dashboard_layout_example", "python"])--

Then in your `app.py`, use it as the root of your page:

--CODE(["app_py_example", "python"])--
...
--CODE(["sidebar_header_example", "python"])--
...
--CODE(["content_header_example", "python"])--
...
--CODE(["main_content_section_example", ""])--
