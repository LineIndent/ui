            ...
            try:
                ...
                for name, obj in inspect.getmembers(module):
                    if hasattr(obj, "__module__") and obj.__module__ == module.__name__:
                        # Check if it's a function, class, or callable assigned to a name
...
def convert_to_pure_markdown(content: str, registry: dict) -> str:
    ...
    def replacer(match):
        ...
        try:
            ...
            obj, preferred_name = registry_entry if registry_entry else (None, str(name))
...
def main():
    ...
    for md_file in DOCS_SOURCE_DIR.rglob("*.md"):
        ...
        print(f"Processed: {md_file.relative_to(ROOT_DIR)} -> {output_path.relative_to(ROOT_DIR)}")
